...
As a user I would expect to be able to click on a specific segment of a chart and it would display the number of reported offences that has happened.
...
The counter will always show the total number of offences committed. It starts with the total number of offences for the whole state and then when a user selects a segment of a chart it will change the number of offences to
that selection or combination of selections.

##### Level 1 offence description: 
All the offences have three levels of descriptions. This is a pie chart which shows a level 1 description of offences, which is a number a offences committted against a person or a property.

##### Level 2 offence description: 
This is a pie chart which shows a level 2 description of the offences. It is a number a offences committted by:
...
This is a bar chart which shows a level 3 description of the offences, which is a number a offences committted by:
- theft and related offences
- acts intended to cause injury
- fraud deception and related offences
- property damage and environmental
...
saturday and sunday but not reported untill the monday.
...
- A row chart displaying the top ten suburbs offences commited in the metropolitan and a top ten outside the metropolitan.
...
### Javascript
- Used to built the charts and manipulate the values outputted by the charts.

### Jquery
  
- https://code.jquery.com/jquery-3.3.1.js
- https://code.jquery.com/ui/1.12.1/jquery-ui.js
- Used so the button/s resets the charts and hides the containers.
...
- The project guidelines stated that dc charts are not responsive and are for desktop and large screen viewing. I made the chart containers responsive so they all stacked below each other.
...
button for each chart so i changed it to just having one for all charts, which was a different code and worked. Reference to the code https://stackoverflow.com/questions/21550270/dc-js-unable-to-redraw-charts

- Another problem I encountered was with the reset button and the time graphs. When clicking the reset button, these charts would reset(render) but would filter to the prevously zoomed option. After a lot of research and
different codes to try to remedy this, nothing was working and because of that I changed the zoom option to the brush option. I would have much prefered the zoom option because it was much easier to see specific results in a 
less cluttered area.
